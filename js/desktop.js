$(function(){
    var tools=[
       ...
       {name:'流量卡店铺①',url:'https://haokawx.lot-ml.com/Product/Index/551526',icon:'./img/a.webp'},
        {name:'流量卡店铺②',url:'https://hk.yunhaoka.cn/#/pages/micro_store/index?agent_id=6cb2c0fb7667ef94b967e505d8255dd7',icon:'./img/b.webp'},
        {name:'流量卡店铺③',url:'https://wap.kaboshihaoka.com/show/?agent_id=69398',icon:'./img/c.webp'},
        {name:'流量卡店铺④',url:'https://index.feihuang.vip/hk/index?st=1&sc=24032122153306',icon:'./img/d.webp'},
        {name:'代理注册',url:'./dl',icon:'https://picabstract-preview-ftn.weiyun.com/ftn_pic_abs_v3/43c244d52c9d2eb76b5163287bde0c3acab9474b09d25c36c67a837fa60a0b9e2d418ab8392fa120f1b5463dc64e5dce?pictype=scale&from=30111&version=3.3.3.3&fname=PicsArt_05-28-09.01.21.jpg&size=1024'},
       ...
       {name:'安全检测',url:'https://detail.aiuys.com/',icon:'https://picabstract-preview-ftn.weiyun.com/ftn_pic_abs_v3/00fa17d69e57bb892e1258921711334f7764c967918d3c8434de469a222763e83adfc52b188d443bdd6289cb1a304c2f?pictype=scale&from=30111&version=3.3.3.3&fname=PicsArt_05-29-02.57.25.jpg&size=1024'},
        ...
        {name:'流量消耗',url:'/tool/ll',icon:'https://net.netart.cn/icon.png'},
        ...
        {name:'游戏',url:'https://www.crazygames.com/',icon:'./img/g.webp'},
